...
논문 저자명과 특허 출원번호는 CV 원문 표기를 유지합니다. 원문의 `Jimyeung Seo`와 `Jimyueng Seo`는 `profile.authorNames`에 등록하여 모두 본인 이름으로 강조합니다. 논문·특허·프로젝트 URL은 원문에 없어 비워두었습니다. 국문 특허명·프로젝트명은 CV 영문 제목의 번역이며, 공식 국문 명칭이 있다면 교체하세요.
